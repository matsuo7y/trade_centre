...
from ..indicator import (
    IndicatorType,
    MACDIndicator, MACDIndicatorSign,
    ADXIndicator, ADXIndicatorSign,
    ROCIndicator, ROCIndicatorSign
)
from ..progress_recorder import MACDRecorder, ADXRecorder, ROCRecorder
...
class QuadSignTradeStrategy(AbstractTradeStrategy):
    ...
    def should_make_long_order(self, indicator_values):
        ...
        return cond_macd_1 and cond_adx and cond_roc
