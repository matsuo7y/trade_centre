...
class ProgressViewApplication:

    def __init__(self, recorders):
        self.recorders = recorders
        self.record_loader = RecordLoader(PROGRESS_ABS_FILE_PATH, recorders)
    ...
    def start_web(self):
        ...
        progress_view_creator = ProgressViewCreator(self.recorders)
        ...
        app.layout = html.Div(children=[
            html.Div(children=[
                ...
                dbc.Badge(children=pos(), id='pos', color='primary', style={'width': '40px'},
                          className='mr-2 text-wrap'),
                dbc.Badge(children=idx(), id='idx', color='danger', style={'width': '40px'},
                          className='mr-2 text-wrap'),
